...
<head>
    ...
    <title>Exercise 1: Getting Started with PHP - Yashodha</title>
</head>
<body>
    <h3>3.1 Write PHP code to output the following message:</h3>
    <?php
        //use back slash to avoid errord giving from special characters
    ...
    <h3>3.3 Define three variables: $g1 = 5, $g2 = 4, and $g3 = 5. These variables represent the grades of three students in the course. 
        To display this information, create an HTML table within your PHP code. The table should be 
        structured with columns for Serial Number (S.n.), Name, and Grade, and it should look like this: </h3>
    <?php
        $g1 = 5; 
        $g2 = 4; 
        $g3 = 5;
    ...
    <img src="images/3.4_docker_setup.PNG" alt="web development environment">
